...
class DenseNet2D_up_block_concat(nn.Module):
    ...
    def match_dimensions(self, prev, curr):
    ...
    def forward(self,prev_feature_map,x):
        ...
        print(f'prev_feature_map shape: {prev_feature_map.shape}')
        print(f'x shape after up-sampling: {x.shape}')
        prev_feature_map, x = self.match_dimensions(prev_feature_map, x)
        print(f'prev_feature_map shape: {prev_feature_map.shape}')
        print(f'x shape after up-sampling: {x.shape}')
